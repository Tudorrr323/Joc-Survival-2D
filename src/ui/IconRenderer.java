...
public class IconRenderer {
    ...
    public static void drawGoldCoin(Graphics2D g2, int x, int y, int size) {
        ...
        g2.fillOval(x+(int)(10*s), y+(int)(10*s), (int)(40*s), (int)(40*s));
        g2.setColor(new Color(218, 165, 32)); // Dark Gold Outline
        g2.setStroke(new BasicStroke((float)(2*s)));
        g2.drawOval(x+(int)(10*s), y+(int)(10*s), (int)(40*s), (int)(40*s));
        g2.setFont(new Font("Arial", Font.BOLD, (int)(24*s))); // Scaled font
        g2.drawString("$", x+(int)(24*s), y+(int)(38*s));
    ...
    private static void drawRat(Graphics2D g2, int x, int y, int size) { 
        // Keep rat if it exists, otherwise it's just extra code
        double s = size / 60.0;
    ...
    public static void drawWood(Graphics2D g2, int x, int y, int size) { 
        double s = size / 60.0;
        g2.setColor(new Color(90, 60, 30)); 
        int[] px = {x+(int)(5*s), x+(int)(45*s), x+(int)(55*s), x+(int)(15*s)}; 
        int[] py = {y+(int)(15*s), y+(int)(5*s), y+(int)(45*s), y+(int)(55*s)}; 
        g2.fillPolygon(px, py, 4); 
        g2.setColor(new Color(160, 120, 60)); 
        g2.fillOval(x+(int)(12*s), y+(int)(42*s), (int)(12*s), (int)(8*s)); 
        g2.setColor(new Color(120, 90, 40)); 
        g2.drawOval(x+(int)(12*s), y+(int)(42*s), (int)(12*s), (int)(8*s)); 
    }
    public static void drawStone(Graphics2D g2, int x, int y, int size) { 
        double s = size / 60.0;
        g2.setColor(new Color(120, 120, 125)); 
        int[] px = {x+(int)(10*s), x+(int)(50*s), x+(int)(55*s), x+(int)(15*s)}; 
        int[] py = {y+(int)(15*s), y+(int)(10*s), y+(int)(50*s), y+(int)(55*s)}; 
        g2.fillPolygon(px, py, 4); 
        g2.setColor(Color.WHITE); 
        g2.drawLine(x+(int)(15*s), y+(int)(15*s), x+(int)(25*s), y+(int)(15*s)); 
    }
    ...
    public static void drawHelmet(Graphics2D g2, int x, int y, int size) { 
        double s = size / 60.0;
        g2.setColor(Color.GRAY); 
        g2.fillArc(x+(int)(10*s), y+(int)(10*s), size-(int)(20*s), size-(int)(20*s), 0, 180); 
        g2.fillRect(x+(int)(15*s), y+size/2, (int)(6*s), (int)(15*s)); 
        g2.fillRect(x+size-(int)(21*s), y+size/2, (int)(6*s), (int)(15*s)); 
        g2.setColor(Color.LIGHT_GRAY); 
        g2.fillRect(x+(int)(22*s), y+(int)(15*s), (int)(4*s), (int)(20*s)); 
    }
    public static void drawChestplate(Graphics2D g2, int x, int y, int size) { 
        double s = size / 60.0;
        g2.setColor(Color.GRAY); 
        int[] bx = {x + (int)(15*s), x + (int)(45*s), x + (int)(50*s), x + (int)(10*s)}; 
        int[] by = {y + (int)(10*s), y + (int)(10*s), y + (int)(50*s), y + (int)(50*s)}; 
        g2.fillPolygon(bx, by, 4); 
        g2.setColor(new Color(110, 110, 110)); 
        g2.fillOval(x + (int)(2*s), y + (int)(5*s), (int)(18*s), (int)(18*s)); // Pauldron L
        g2.fillOval(x + (int)(40*s), y + (int)(5*s), (int)(18*s), (int)(18*s)); // Pauldron R
        g2.setColor(Color.DARK_GRAY); 
        g2.drawOval(x + (int)(2*s), y + (int)(5*s), (int)(18*s), (int)(18*s)); 
        g2.drawOval(x + (int)(40*s), y + (int)(5*s), (int)(18*s), (int)(18*s)); 
        g2.setColor(Color.GRAY); 
        g2.fillRect(x + (int)(5*s), y + (int)(20*s), (int)(8*s), (int)(20*s)); // Arm L
        g2.fillRect(x + (int)(47*s), y + (int)(20*s), (int)(8*s), (int)(20*s)); // Arm R
        g2.setColor(new Color(160, 160, 170)); 
        g2.fillRect(x + (int)(20*s), y + (int)(15*s), (int)(20*s), (int)(5*s)); // Detail
        g2.fillRect(x + (int)(28*s), y + (int)(25*s), (int)(4*s), (int)(15*s)); // Detail
    }
    ...
    public static void drawPants(Graphics2D g2, int x, int y, int size) { 
        double s = size / 60.0;
        g2.setColor(Color.GRAY); 
        g2.fillRect(x+(int)(15*s), y+(int)(10*s), size-(int)(30*s), (int)(15*s)); 
        g2.fillRect(x+(int)(15*s), y+(int)(25*s), (int)(12*s), (int)(20*s)); 
        g2.fillRect(x+size-(int)(27*s), y+(int)(25*s), (int)(12*s), (int)(20*s)); 
    }
    public static void drawBoots(Graphics2D g2, int x, int y, int size) { 
        double s = size / 60.0;
        g2.setColor(Color.GRAY); 
        g2.fillRoundRect(x+(int)(10*s), y+(int)(25*s), (int)(12*s), (int)(15*s), (int)(5*s), (int)(5*s)); 
        g2.fillRect(x+(int)(10*s), y+(int)(35*s), (int)(18*s), (int)(10*s)); 
        g2.fillRoundRect(x+size-(int)(22*s), y+(int)(25*s), (int)(12*s), (int)(15*s), (int)(5*s), (int)(5*s)); 
        g2.fillRect(x+size-(int)(22*s), y+(int)(35*s), (int)(18*s), (int)(10*s)); 
    }
    ...
    public static void drawSword(Graphics2D g2, int x, int y, int size) { 
        ...
        g2.fillRect(x+(int)(28*s), y+(int)(5*s), (int)(4*s), (int)(40*s)); // Blade
        g2.setColor(new Color(180, 140, 20)); 
        g2.fillRect(x+(int)(20*s), y+(int)(40*s), (int)(20*s), (int)(6*s)); // Guard
        g2.setColor(new Color(80, 40, 10)); 
        g2.fillRect(x+(int)(28*s), y+(int)(46*s), (int)(4*s), (int)(10*s)); // Hilt
    }
